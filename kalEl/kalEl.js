 ...
 */
  window.KalEl = KalEl = function(element, params, target) {
    ...
    var defaultParams = {
      ...
      /**
       * The visibility behavior: ['auto', 'manual', 'visible'].
      ...
      onDateChanging: function(kalEl, oldDate, newDate){ return true; },
    ...
    var monthSelectEl = kalEl.getElementsByClassName('cal-body-months')[0], //dom element of month selection
      ...
      second = params.seconds ? kalEl.getElementsByClassName('cal-body-time-second')[0] : null, //dom element of second selector body
      secondItems = second ? second.getElementsByTagName('button') : null, //dom element collection of second buttons

      minute = kalEl.getElementsByClassName('cal-body-time-minute')[0], //dom element of minute selector body
      minuteItems = minute.getElementsByTagName('button'), //dom element collection of minute selector buttons

      hour = kalEl.getElementsByClassName('cal-body-time-hour')[0], //dom element of hour selector body
      hourItems = hour.getElementsByTagName('button'), //dom element collection of hour selector buttons
    ...
    var hourHeadEl = hour.getElementsByClassName('cal-list-head')[0],
      minuteHeadEl = minute.getElementsByClassName('cal-list-head')[0],
      secondHeadEl = params.seconds ? second.getElementsByClassName('cal-list-head')[0] : null;
